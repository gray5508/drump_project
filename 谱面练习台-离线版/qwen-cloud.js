    ...
    socket.send(JSON.stringify({
      ...
      session: {
        ...
        input_audio_transcription: {
          language: "zh",
          corpus: {
            text: "完整谱面。完整谱面界面。默认界面。返回默认界面。切换到完整谱面。按行练习。按行练习界面。切换按行练习。切换到按行练习界面。进入按行练习。小节编排。小节编排界面。切换小节编排。切换到小节编排界面。进入小节编排。小节。下一小节。下一节。切到下一节。往后一个小节。上一小节。上一节。切到上一节。往前一个小节。下一个。上一个。下一个视频。上一个视频。下一片段。上一片段。下一行。上一行。播放视频。播放教学视频。视频。暂停视频。暂停播放。继续播放。恢复播放。关闭视频。关闭教学视频。播放伴奏。开始伴奏。继续伴奏。暂停伴奏。关闭伴奏。播放第一小节。播放第十小节。播放第四十八小节。播放第四十八小节伴奏。伴奏速率零点八。伴奏倍率零点八。伴奏倍速零点八。伴奏速率一点二。伴奏倍率一点二。伴奏倍速一点二。零点八倍速伴奏。一点二倍速伴奏。快进十秒。快进二十秒。后退五秒。后退十秒。第一个小节。第十小节。第四十六小节。"
          }
        },
        turn_detection: {
          type: "server_vad",
